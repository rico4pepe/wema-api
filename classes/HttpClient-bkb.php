...
class HttpClient
{
    ...
    {
        // Check if the required keys are present in the config array
        if (!isset($config['base_url']) || !isset($config['x-api-key'])) {
            throw new InvalidArgumentException('Missing required configuration keys: base_url, x-api-key');
        }
